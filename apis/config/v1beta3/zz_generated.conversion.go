...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*NetworkTrafficArgs)(nil), (*config.NetworkTrafficArgs)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1beta3_NetworkTrafficArgs_To_config_NetworkTrafficArgs(a.(*NetworkTrafficArgs), b.(*config.NetworkTrafficArgs), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*config.NetworkTrafficArgs)(nil), (*NetworkTrafficArgs)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_config_NetworkTrafficArgs_To_v1beta3_NetworkTrafficArgs(a.(*config.NetworkTrafficArgs), b.(*NetworkTrafficArgs), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1beta3_NetworkTrafficArgs_To_config_NetworkTrafficArgs(in *NetworkTrafficArgs, out *config.NetworkTrafficArgs, s conversion.Scope) error {
	if err := v1.Convert_Pointer_string_To_string(&in.Address, &out.Address, s); err != nil {
		return err
	}
...
// Convert_v1beta3_NetworkTrafficArgs_To_config_NetworkTrafficArgs is an autogenerated conversion function.
func Convert_v1beta3_NetworkTrafficArgs_To_config_NetworkTrafficArgs(in *NetworkTrafficArgs, out *config.NetworkTrafficArgs, s conversion.Scope) error {
	return autoConvert_v1beta3_NetworkTrafficArgs_To_config_NetworkTrafficArgs(in, out, s)
}

func autoConvert_config_NetworkTrafficArgs_To_v1beta3_NetworkTrafficArgs(in *config.NetworkTrafficArgs, out *NetworkTrafficArgs, s conversion.Scope) error {
	if err := v1.Convert_string_To_Pointer_string(&in.Address, &out.Address, s); err != nil {
		return err
	}
...
// Convert_config_NetworkTrafficArgs_To_v1beta3_NetworkTrafficArgs is an autogenerated conversion function.
func Convert_config_NetworkTrafficArgs_To_v1beta3_NetworkTrafficArgs(in *config.NetworkTrafficArgs, out *NetworkTrafficArgs, s conversion.Scope) error {
	return autoConvert_config_NetworkTrafficArgs_To_v1beta3_NetworkTrafficArgs(in, out, s)
}
